# -*- coding: utf-8 -*-
"""ML_project_parkinsons_NN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11kKC0T-pdpI_Pd3mN2Q7NE5Eb5MsqpIY
"""
...
def backpropagation(x_train,y_train,layers,weights, lamb, alpha,iteration):
  ...
  for inn in range(0,iteration,1):
    ...
    total_cost_train = total_cost_train - p/len(x_train)
...
hidden_layers = [[22,16,16,2],[22,32,32,2]]
...
for layers in hidden_layers:
  for i in range(0,k_fold):
    ...
    weights, costs = backpropagation(X_train.values,Y_train.values,layers,weights,0.5, 0.1, 500)
...
#93.0952380952381
#83.57479253112033
# accuracy[22,16,16,2][22,32,32,2]
#79.5761988
#81.080994
# f1_measure
# 83.7619904
